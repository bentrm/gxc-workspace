...
Ext.define('Deft.mvc.ViewController', {
  ...
  onViewInitialize: function() {
    var config, id, listeners, live, originalViewDestroyFunction, ref, selector, self;
    if (Ext.getVersion('extjs') != null) {
  ...
  removeObservers: function() {
    var observer, ref, target;
    ref = this.registeredObservers;
    for (target in ref) {
      observer = ref[target];
      observer.destroy();
  ...
  return Deft.Class.registerPreprocessor('observe', function(Class, data, hooks, callback) {
    Deft.Class.hookOnClassExtended(data, function(Class, data, hooks) {
      var ref;
      if (Class.superclass && ((ref = Class.superclass) != null ? ref.observe : void 0) && Deft.Class.extendsClass(Class, 'Deft.mvc.ViewController')) {
