...
Ext.define('Deft.promise.Promise', {
  ...
  statics: {
    ...
    all: function(promisesOrValues) {
      ...
      return Deft.Promise.when(promisesOrValues).then(function(promisesOrValues) {
        var deferred, i, index, len, promiseOrValue, remainingToResolve, resolve, results;
    ...
    some: function(promisesOrValues, howMany) {
      ...
      return Deft.Promise.when(promisesOrValues).then(function(promisesOrValues) {
        var deferred, i, index, len, onReject, onResolve, promiseOrValue, remainingToReject, remainingToResolve, values;
        values = [];
  ...
  then: function(onFulfilled, onRejected, onProgress, scope) {
    ...
    if (arguments.length === 1 && Ext.isObject(arguments[0])) {
      ref = arguments[0], onFulfilled = ref.success, onRejected = ref.failure, onProgress = ref.progress, scope = ref.scope;
    }
    if (scope != null) {
  ...
  otherwise: function(onRejected, scope) {
    var ref;
    if (arguments.length === 1 && Ext.isObject(arguments[0])) {
      ref = arguments[0], onRejected = ref.fn, scope = ref.scope;
    }
    if (scope != null) {
      onRejected = Ext.Function.bind(onRejected, scope);
    }
  ...
  always: function(onCompleted, scope) {
    var ref;
    if (arguments.length === 1 && Ext.isObject(arguments[0])) {
      ref = arguments[0], onCompleted = ref.fn, scope = ref.scope;
    }
    if (scope != null) {
