...
describe('Deft.mixin.Controllable', function() {
  return describe("when a Component or Container specifies the 'controller' class annotation", function() {
    specify('creates an instance of the view controller specified by the target view `controller` class annotation and configures it with a reference to the target view instance when an instance of the target view is created', function() {
    ...
    specify('passes the configuration object passed to the target view\'s `controllerConfig` config to the view controller\'s constructor', function() {
      var constructorSpy, exampleViewControllerInstance, exampleViewInstance;
      Ext.define('ExampleViewController', {
        extend: 'Deft.mvc.ViewController',
        config: {
      ...
      expect(constructorSpy).to.be.calledOnce.and.calledWith({
        value: 'expected value'
      });
      exampleViewControllerInstance = constructorSpy.lastCall.thisValue;
      expect(exampleViewControllerInstance.getView()).to.equal(exampleViewInstance);
    ...
    specify('automatically adds a getController() accessor method to the target view that returns the associated the view controller instance', function() {
      var constructorSpy, exampleViewControllerInstance, exampleViewInstance;
      Ext.define('ExampleViewController', {
        extend: 'Deft.mvc.ViewController'
      });
    ...
    specify('only creates and attaches the most specific controller (i.e. the controller specified for the subclass) in an inheritance tree where multiple controllers are specified', function() {
    ...
    specify('only creates and attaches the most specific controller (i.e. the controller specified for the subclass) in an inheritance tree where multiple controllers are specified (and the leaf class does not define a constructor)', function() {
      var baseViewControllerConstructorSpy, baseViewControllerInstance, baseViewInstance, extendedViewControllerConstructorSpy, extendedViewControllerInstance, extendedViewInstance;
      Ext.define('BaseViewController', {
        extend: 'Deft.mvc.ViewController',
        constructor: function() {
    ...
    specify('only creates and attaches the most specific controller (i.e. the controller specified for the subclass) in an inheritance tree where multiple controllers are specified (and the root class does not define a constructor)', function() {
      var baseViewControllerConstructorSpy, baseViewControllerInstance, baseViewInstance, extendedViewControllerConstructorSpy, extendedViewControllerInstance, extendedViewInstance;
      Ext.define('BaseViewController', {
        extend: 'Deft.mvc.ViewController',
        constructor: function() {
    ...
    specify('re-throws any error thrown by the view controller during instantiation', function() {
      ...
      }).to["throw"](Error, 'Error thrown by \`ExampleErrorThrowingViewController\`.');
