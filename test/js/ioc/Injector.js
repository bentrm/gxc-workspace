...
describe('Deft.ioc.Injector', function() {
  ...
  describe('Configuration', function() {
    var configuredIdentifiers, describeConfigurationByValueOfType, i, len, typeDescriptor, typeDescriptors;
    ...
    for (i = 0, len = typeDescriptors.length; i < len; i++) {
      typeDescriptor = typeDescriptors[i];
    ...
    describe('Resolution', function() {
      specify('should resolve a value for configured identifiers', function() {
        var configuredIdentifier, j, len1;
        for (j = 0, len1 = configuredIdentifiers.length; j < len1; j++) {
          configuredIdentifier = configuredIdentifiers[j];
      ...
      specify('should pass the instance specified for resolution when lazily resolving a dependency with a factory function', function() {
        ...
        for (j = 0, len1 = factoryFunctionIdentifiers.length; j < len1; j++) {
          factoryFunctionIdentifier = factoryFunctionIdentifiers[j];
    ...
    describe('Injection', function() {
      ...
      specify('should inject configured dependencies into properties for a given class instance', function() {
        var configuredIdentifier, j, len1, resolvedValue, simpleClassInstance;
      ...
      specify('should inject configured dependencies into configs for a given class instance', function() {
        var complexClassInstance, configuredIdentifier, getterFunctionName, j, len1, resolvedValue;
      ...
      specify('should automatically inject configured dependencies into properties for a given Injectable class instance', function() {
        var configuredIdentifier, j, len1, resolvedValue, simpleInjectableClassInstance;
      ...
      specify('should automatically inject configured dependencies into configs for a given Injectable class instance', function() {
        var configuredIdentifier, getterFunctionName, injectableComplexClassInstance, j, len1, resolvedValue;
      ...
      specify('should automatically inject configured dependencies into configs for a given Injectable \`Ext.Component\` subclass instance', function() {
        var configuredIdentifier, getterFunctionName, injectableComponentSubclassInstance, j, len1, resolvedValue;
